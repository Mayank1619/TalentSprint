  ...
  return (
    <main className="page-shell">
      <section className="page-heading compact">
        ...
        <p>
          Demo invitation link accepted. The real version will validate candidate identity, invitation
          token, server-side timer, and assessment snapshot before start.
        </p>
      </section>
